...
class IndividualChat extends StatefulWidget {
  final String name;
  final String chatid;
  const IndividualChat({super.key, required this.chatid, required this.name});
      ...
      appBar: PreferredSize(
        ...
        child: Container(
          ...
          child: AppBar(
            ...
            elevation: 0,
            leading: IconButton(onPressed:()=>Navigator.pop, icon: Icon(Icons.keyboard_arrow_left_rounded, color: AppColors.navbarcolorbg,)),
            title: Text(
              widget.name,
              style: TextStyle(
          ...
          Expanded(
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                DateTime msgDate = DateTime.parse(messages[index]['time']).toLocal();
                    ...
                    if (showDate)
                      Center(
                        child: Container(
                          ...
                          child: Text(dateLabel, style: const TextStyle(fontSize: 12 , color: AppColors.darkviolet)),
                        ),
                      ),
                    Align(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(messages[index]['text'],
                                style: TextStyle(color: isMe ? Colors.white : AppColors.darkviolet)),
