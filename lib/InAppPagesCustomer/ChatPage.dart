      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            Text('Messages',style: TextStyle(fontSize: 22 , fontWeight: FontWeight.bold, color: AppColors.darkviolet), ),
  ...
  return Column(
    children: chatData.map((chat) {
      return Padding(
        ...
        child: InkWell(
          onTap: () {
            Navigator.push(context, MaterialPageRoute(builder: (builder) => IndividualChat(chatid: chat['chatId'], name: chat['name'],)));
          },
          child: Container(
            ...
            child: Row(
              ...
              children: [
                ...
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text(chat["name"], style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
                    SizedBox(height: 4),
                    Text(chat["lastChat"], style: TextStyle(color: Colors.grey[600])),
                  ],
                ),
                Spacer(),
                Text(
